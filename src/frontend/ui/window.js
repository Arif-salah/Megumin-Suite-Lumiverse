...
import { hydrateIcons, watchIcons, LAUNCHER_ICON_SVG } from "./icon.js";
...
export function buildSettingsWindow(mount) {
    ...
    // Watch the whole window, not just hydrate it once. Tabs re-render
    // themselves in place on nearly every click without going through
    // switchTab(), and the fresh markup arrives as bare <i> tags. See the note
    // in ui/icon.js.
    watchIcons(mount.root);
    closeSettingsWindow();
    return mount.root;
}
