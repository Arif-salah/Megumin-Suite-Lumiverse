...
// caller in the block pipeline asks "which blocks am I not rendering inline?" and
// answering that with a constant [] is clearer than threading the removal through
// each of them. If a panel-like placement is added later (a Spindle dock panel is
// the obvious candidate), this is the one place that has to learn about it.
