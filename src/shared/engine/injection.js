...
import { sdGenreLabel } from "../storyplan/genres.js";
...
export async function buildPromptMessages(messages, context = {}) {
    ...
    // The host's macro engine, or a passthrough when the caller has none.
    // Named substituteParams below so the ported call sites read as they did.
